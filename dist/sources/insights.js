...
exports.default = (feed) => fetcher_1.default(feed, records => {
    const stats = records.map(({ data, cadeias_transmissao, confirmados, confirmados_0_9_f, confirmados_0_9_m, confirmados_10_19_f, confirmados_10_19_m, confirmados_20_29_f, confirmados_20_29_m, confirmados_30_39_f, confirmados_30_39_m, confirmados_40_49_f, confirmados_40_49_m, confirmados_50_59_f, confirmados_50_59_m, confirmados_60_69_f, confirmados_60_69_m, confirmados_70_79_f, confirmados_70_79_m, confirmados_80_plus_f, confirmados_80_plus_m, confirmados_acores, confirmados_arsalentejo, confirmados_arsalgarve, confirmados_arscentro, confirmados_arslvt, confirmados_arsnorte, confirmados_estrangeiro, confirmados_madeira, confirmados_novos, n_confirmados, internados, internados_uci, transmissao_importada, lab, obitos_0_9_m, obitos, obitos_0_9_f, obitos_10_19_f, obitos_10_19_m, obitos_20_29_f, obitos_20_29_m, obitos_30_39_f, obitos_30_39_m, obitos_40_49_f, obitos_40_49_m, obitos_50_59_f, obitos_50_59_m, obitos_60_69_f, obitos_60_69_m, obitos_70_79_f, obitos_70_79_m, obitos_80_plus_f, obitos_80_plus_m, obitos_acores, obitos_arsalentejo, obitos_arsalgarve, obitos_arscentro, obitos_arslvt, obitos_arsnorte, obitos_estrangeiro, obitos_madeira, recuperados, suspeitos, vigilancia, }) => {
        const result = {
            cases: {
                confirmed: {
        ...
        if (obitos !== undefined)
            result.deaths = {
                total: isNumeric_1.default(obitos) ? Number(obitos) : null,
            };
        if (recuperados !== undefined) {
            result.recovered = {
                total: isNumeric_1.default(recuperados) ? Number(recuperados) : null,
            };
        }
        if (internados !== undefined) {
            result.hospitalization = {
                total: isNumeric_1.default(internados) ? Number(internados) : null,
            };
            if (internados_uci !== undefined) {
                result.critical = {
                    total: isNumeric_1.default(internados_uci) ? Number(internados_uci) : null,
                };
            }
        }
        if (lab !== undefined) {
        ...
        }).forEach(({ group, type, confirmed, deaths }) => {
            var _a;
            (_a = result.groups) === null || _a === void 0 ? void 0 : _a.push({
                // @ts-ignore
                type,
                label: {
